...
const Register = (props) => {
  ...
  const handleRegister = async (e) => {
    ...
    try {
      ...
      if (
        ...
        err.response.data === "Username is already taken"
      ) {
  ...
  useEffect(() => {
    const regexPhoneNumber = /(84|0[3|5|7|8|9])+([0-9]{8})\b/g;
    const isPhoneError =
      !regexPhoneNumber.test(phone_number) && phone_number !== "";
  ...
  return (
    <form method="POST" className="sign-up-form" onSubmit={handleRegister}>
      ...
      <div
        className={`input-field${phoneError ? " register-error" : ""}`}
        id="error-field-sign-up-phone"
      >
      ...
      <div
        className={`input-field${passwordError ? " register-error" : ""}`}
        id="error-field-sign-up-password"
      >
      ...
      <div
        className={`input-field${
          confirmPasswordError ? " register-error" : ""
        }`}
        id="error-field-sign-up-confirm-password"
      >
        <FaLock className="icon" />
        <input
