          ...
          <div className={active}>
            <ul className="navLists flex">
              <li className="navItem">
                <Link to={"/"} className="navLink" onClick={scrollToTop}>
                  {t("home")}
                </Link>
              </li>

              <li className="navItem">
                <a href="#tours" className="navLink">
                  {t("tours")}
                </a>
              </li>
              ...
              <li className="navItem">
                <a href="#lang" className="navLink dropbtn">
                  {t("language")}
                </a>
                <div className="dropdown-lang">
                  <a href="#vi" onClick={() => changeLanguage("vi")}>
                    {t("vietnamese")}
                  </a>
              ...
              {!user && (
                <Link to={"/login"}>
                  <button className="btn">{t("book now")}</button>
                </Link>
              )}
